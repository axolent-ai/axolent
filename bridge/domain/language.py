...
_MARKERS: dict[str, set[str]] = {
    ...
    "fr": {
        ...
        "oui",
        "non",
        # FR-unique markers (not in PT/ES/IT) for short-text disambiguation
        "moi",
        "toi",
        "soi",
        "lui",
    ...
    "es": {
        ...
        "gracias",
        "hola",
        # ES-unique markers (not in FR/PT/IT) for short-text disambiguation
        "cuentame",
        "historia",
        "espanol",
        "donde",
    ...
    "sv": {
        ...
        "över",
        "göra",
        # ASCII transliterations (users often type without diacritics)
        "paa",
        "fran",
        "har",
        "ocksa",
        ...
        "nagot",
        "nagon",
        # Content words that are SV-unique (not DE/EN/DA/NB)
        "hela",
        "historien",
        "svenska",
        "beraetta",
